      ...
      <div className="min-h-screen flex items-center justify-center px-4 py-8 relative z-10">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center mb-8">
            ...
            <h1 className="text-4xl font-bold bg-clip-text text-transparent bg-linear-to-r from-orange-600 to-green-500 mb-2">
              Hesab Yarat
            </h1>
            <p className="text-gray-600 text-sm">
              Yeni reseptləri kəşf etmək üçün qeydiyyatdan keç
            </p>
          </motion.div>
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <motion.button
                type="submit"
                disabled={isLoading}
                className="w-full bg-linear-to-r from-orange-500 to-green-400 text-white py-3 md:py-4 rounded-2xl font-semibold shadow-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all"
